...
- **Model:** Copilot Sonnet 4 (claude-sonnet-4-20250514)
...
Standard Copilot CLI with default settings:
- No OMP extensions loaded
- Default system prompt
- Single-agent execution

### OMP Configuration

Oh-My-Copilot enhanced with:
...
Instances that OMP solved but vanilla failed:
...
Instances that vanilla solved but OMP failed:
...
# Install oh-my-copilot (if testing OMP)
...
- [Oh-My-Copilot Documentation](../README.md)
