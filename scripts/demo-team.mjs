...
const config = {
  ...
  tasks: [
    ...
    { subject: 'Write a haiku about Copilot', description: 'Write a short haiku (3 lines, 5-7-5 syllables) about AI assistants. Output it and exit.' },
  ],
  cwd: process.cwd(),
};

console.log('Starting team "demo" with 2 Copilot workers...');
