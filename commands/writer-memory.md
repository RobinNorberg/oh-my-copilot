...
This compatibility command keeps `/oh-my-copilot:writer-memory` available without loading the full `writer-memory` skill description in every Claude Code session.
