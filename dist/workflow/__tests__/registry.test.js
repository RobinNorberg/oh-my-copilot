...
import { REGISTRY_OWNER, REGISTRY_SCHEMA_VERSION, REGISTRY_VERSION, TIER0_ROLES, RISK_CLASSES, HARD_RISK_CLASSES, RETIREMENT_POLICY, REMOVAL_MILESTONE, WORKFLOW_ENTRIES, WORKFLOW_ROLES, getEntry, getRole, resolveCanonical, isHardRisk, failModeForRisk, isRegistryEnabled, registryAliasLookup, } from '../registry.js';
...
describe('workflow registry — aliases and classification', () => {
    it('classifies all 51 installed skills and 21 installed commands exactly once', () => {
        ...
        // minimal-code-discipline, launch, and drydock, and upstream v5.3.0's
        // ask-navigator and loft.
