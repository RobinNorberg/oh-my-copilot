...
const DEFAULT_CONFIG = {
    ...
    verbose: false,
    stateFilePath: join(homedir(), '.omg', 'state', 'rate-limit-daemon.json'),
    pidFilePath: join(homedir(), '.omg', 'state', 'rate-limit-daemon.pid'),
    logFilePath: join(homedir(), '.omg', 'state', 'rate-limit-daemon.log'),
};
