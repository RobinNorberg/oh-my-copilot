...
import { OmgPaths, validateWorkingDirectory, } from "../../lib/worktree-paths.js";
 ...
 */
export function readState(name, location = StateLocation.LOCAL) {
...
export class StateManager {
    ...
    read() {
        return readState(this.name, this.location);
    }
    write(data, options) {
