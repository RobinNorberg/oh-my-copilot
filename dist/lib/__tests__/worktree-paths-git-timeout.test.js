...
import { clearWorktreeCache, getProjectIdentifier, resolveTranscriptPath, } from '../../lib/worktree-paths.js';
...
function installWedgedGit(dir, wedgedArgs) {
...
describe.skipIf(process.platform === 'win32')('worktree-paths git calls are bounded (#3946)', () => {
    ...
    it('the wedged shim really does hang the subcommand it targets', () => {
        ...
        expect(() => execFileSync(join(bin, 'git'), ['remote', 'get-url', 'origin'], {
            cwd: repo,
            encoding: 'utf-8',
        ...
        expect(execFileSync(join(bin, 'git'), ['rev-parse', '--show-toplevel'], {
            cwd: repo,
            encoding: 'utf-8',
            stdio: ['pipe', 'pipe', 'pipe'],
            timeout: 5_000,
...
//# sourceMappingURL=worktree-paths-git-timeout.test.js.map