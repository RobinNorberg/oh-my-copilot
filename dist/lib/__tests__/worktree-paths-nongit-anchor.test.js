...
import { getOmcRoot, validateWorkingDirectory, resolveStateWorkingDirectory, resolveNonGitStateAnchor, isSensitiveStateLocation, clearWorktreeCache, ensureAllOmcDirs, } from '../worktree-paths.js';
const gitAvailable = (() => {
    try {
...
beforeEach(() => {
    ...
    if (prevDisableMultirepo === undefined)
        delete process.env.OMC_DISABLE_MULTIREPO;
    else
        process.env.OMC_DISABLE_MULTIREPO = prevDisableMultirepo;
    clearWorktreeCache();
});
afterEach(() => {
...
//# sourceMappingURL=worktree-paths-nongit-anchor.test.js.map