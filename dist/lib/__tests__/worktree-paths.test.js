...
import { validatePath, resolveOmcPath, resolveStatePath, ensureOmcDir, getWorktreeNotepadPath, getWorktreeProjectMemoryPath, getOmcRoot, getSharedOmcRoot, resolvePlanPath, resolveResearchPath, resolveLogsPath, resolveWisdomPath, isPathUnderOmc, ensureAllOmcDirs, clearWorktreeCache, getProcessSessionId, resetProcessSessionId, validateSessionId, resolveToWorktreeRoot, validateWorkingDirectory, getWorktreeRoot, getProjectIdentifier, clearDualDirWarnings, migrateOmcpContentToOmc, clearOmcpContentWarnings, } from '../worktree-paths.js';
    ...
    describe('migrateOmcpContentToOmc', () => {
        ...
        it('keeps the .omc/ copy and warns once when both exist', () => {
            ...
            try {
                ...
                const conflictWarns = warnSpy.mock.calls.filter(c => typeof c[0] === 'string' && c[0].includes('omc-share') && c[0].includes('Both'));
