 ...
 */
export declare const OMC_PLUGIN_MARKETPLACE_SLUG = "omg";
export declare const OMC_PLUGIN_PACKAGE_NAME = "oh-my-copilot";
export declare const OMC_PLUGIN_CACHE_REL = "plugins/cache/omg/oh-my-copilot";
export declare const OMC_PLUGIN_MARKETPLACE_REL = "plugins/marketplaces/omg";
export declare const OMC_HUD_DIST_REL = "dist/hud/index.js";
export declare const OMC_HUD_WRAPPER_REL = "hud/omcp-hud.mjs";
