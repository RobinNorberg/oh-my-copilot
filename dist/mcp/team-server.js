...
const OMC_JOBS_DIR = process.env.OMC_JOBS_DIR || join(homedir(), '.omg', 'team-jobs');
...
const startSchema = z.object({
    ...
    agentTypes: z.array(z.string()).describe('Agent type per worker: "copilot", "codex", or "gemini"'),
