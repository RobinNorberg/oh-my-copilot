...
vi.mock('../../lib/worktree-paths.js', () => ({
    resolveOmcPath: vi.fn((relativePath, worktreeRoot) => `${worktreeRoot ?? '/detected/root'}/.omg/${relativePath}`),
}));
...
function stubResolver() {
    mockResolveOmcPath.mockImplementation((relativePath, worktreeRoot) => `${worktreeRoot ?? '/detected/root'}/.omg/${relativePath}`);
}
...
//# sourceMappingURL=ado-config.test.js.map