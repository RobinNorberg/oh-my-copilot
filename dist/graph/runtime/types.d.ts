 ...
 */
import type { GraphApprovalDecision, GraphCommittedTransition, GraphNode, GraphNodeKind, GraphSchedulerProjection, SealedGraphDescriptor, GraphEvidenceReference } from "../types.js";
/**
...
export declare class FenceError extends Error {
...
export interface NodeExecutionContext {
    ...
    readonly node: Extract<GraphNode, {
        kind: ExecutableKind;
    }>;
...
export type RuntimeProgressEvent = {
    ...
    readonly type: "node_result";
    readonly node_id: string;
    readonly outcome: "succeeded" | "failed" | "approved" | "denied" | "join_resolved";
} | {
...
export declare const EXIT_CODES: {
    readonly OK: 0;
    readonly FAILED_TERMINAL: 1;
    readonly FENCED_OUT: 19;
    readonly CORRUPT_JOURNAL: 20;
    readonly DESCRIPTOR_MISMATCH: 21;
};
