...
import { createAsciiProgressReporter, renderProgressEvent, } from "../../runtime/progress.js";
describe("renderProgressEvent", () => {
    ...
    it("renders replayed", () => {
        const event = { type: "replayed", records: 7, epoch: 2 };
...
describe("createAsciiProgressReporter", () => {
    ...
    it("defaults to process.stdout and does not throw", () => {
        ...
        expect(() => reporter.onEvent({ type: "run_started", run_id: "r-default", goal: "" })).not.toThrow();
    });
});
