 ...
 */
export declare function readHudState(directory?: string, _sessionId?: string): OmcHudState | null;
/**
 * Write HUD state to disk (local only)
 */
export declare function writeHudState(state: OmcHudState, directory?: string, _sessionId?: string): boolean;
/**
 ...
 */
export declare function initializeHUDState(directory?: string, _sessionId?: string): Promise<void>;
