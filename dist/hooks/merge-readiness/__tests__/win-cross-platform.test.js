...
import { collectMergeReadinessEvidence, createInitialMergeReadinessState, readMergeReadinessState, slugifyMergeReadiness, } from "../index.js";
import { getOmcRoot, resolveSessionStatePath, resolveToWorktreeRoot, validateSessionId, } from "../../../lib/worktree-paths.js";
...
describe("merge-readiness Windows cross-platform contract", () => {
    ...
    it("resolves the worktree root from a subdirectory (not a subdirectory itself)", () => {
        ...
        if (isWin32) {
            ...
            const norm = (x) => x.toLowerCase().split("\\").join("/");
...
//# sourceMappingURL=win-cross-platform.test.js.map