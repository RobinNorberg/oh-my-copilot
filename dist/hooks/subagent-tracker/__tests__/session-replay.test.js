...
describe('session-replay', () => {
    ...
    describe('event helpers', () => {
        it('recordAgentStart should record start event', () => {
            recordAgentStart(testDir, 'sess3', 'agent-123', 'oh-my-copilot:executor', 'Fix the bug', 'ultrawork', 'sonnet');
        ...
        it('recordAgentStop should record stop event', () => {
            recordAgentStop(testDir, 'sess4', 'agent-456', 'oh-my-copilot:architect', true, 5000);
