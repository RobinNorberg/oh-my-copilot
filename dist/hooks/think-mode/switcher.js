 ...
 */
import { COPILOT_FAMILY_DEFAULTS, COPILOT_FAMILY_HIGH_VARIANTS, getClaudeHighVariantFromModel, } from '../../config/models.js';
/**
...
function resolveProvider(providerId, modelId) {
    ...
    if (providerId === 'github-copilot') {
        ...
        if (modelLower.includes('claude') || modelLower.includes('gh'))
            return 'anthropic';
