...
vi.mock('../../lib/worktree-paths.js', async () => {
    ...
    return {
        ...
        getOmcRoot: (dir) => join(dir || testDir, '.omcp'),
    };
});
describe('trace-tools', () => {
    ...
    describe('agent breakdown in summary', () => {
        ...
        it('should show execution flow section', async () => {
            ...
            appendReplayEvent(testDir, 'flow-exec', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-copilot:plan' });
            ...
            expect(text).toContain('oh-my-copilot:plan invoked');
    ...
    describe('skills_invoked in summary', () => {
        it('should show skills invoked via Skill tool', async () => {
            appendReplayEvent(testDir, 'sk-sess', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-copilot:plan' });
            appendReplayEvent(testDir, 'sk-sess', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-copilot:ultrawork' });
            ...
            expect(text).toContain('oh-my-copilot:plan');
            expect(text).toContain('oh-my-copilot:ultrawork');
        });
        it('should format skill_invoked in timeline', async () => {
            appendReplayEvent(testDir, 'sk-tl', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-copilot:plan' });
        ...
        it('should include skill_invoked in skills filter', async () => {
            appendReplayEvent(testDir, 'sk-flt', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-copilot:plan' });
