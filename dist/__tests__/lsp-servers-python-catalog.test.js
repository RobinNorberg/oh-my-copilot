...
async function renderServerStatus(installedCommand) {
    vi.resetModules();
    vi.doMock('child_process', () => ({
        spawnSync: vi.fn((_command, args) => args[0] === installedCommand
...
//# sourceMappingURL=lsp-servers-python-catalog.test.js.map