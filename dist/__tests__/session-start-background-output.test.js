...
describe("session-start background output isolation", () => {
    it("keeps foreground hook stdout/stderr clean when notification module writes", () => {
        ...
        writeFileSync(join(notificationsDir, "index.js"), `export async function notify() { console.log("BACKGROUND_STDOUT_LEAK"); console.error("BACKGROUND_STDERR_LEAK"); }\n`);
        writeFileSync(join(notificationsDir, "reply-listener.js"), `export async function buildDaemonConfig() { return null; }\nexport function startReplyListener() {}\n`);
        try {
...
//# sourceMappingURL=session-start-background-output.test.js.map