...
export async function shutdownTeam(
  ...
  // CLI workers (copilot/codex/gemini/grok tmux pane processes) never write shutdown-ack.json.
  ...
  const CLI_AGENT_TYPES = new Set<string>(['claude', 'copilot', 'codex', 'gemini', 'grok']);
