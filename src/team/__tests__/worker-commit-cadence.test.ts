...
describe('worker name validation (shell injection guard)', () => {
  ...
  it('startFallbackPoller throws on injectable name (synchronous)', () => {
    expect(() =>
      startFallbackPoller(worktreePath, "alice'; touch /tmp/pwn; #"),
