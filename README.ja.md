...
[はじめる](#クイックスタート) • [ドキュメント](https://docs/REFERENCE.md) • [CLI リファレンス](https://docs/REFERENCE.md/docs.html#cli-reference) • [ワークフロー](https://docs/REFERENCE.md/docs.html#workflows) • [移行ガイド](docs/MIGRATION.md)
...
### 実行モード
用途に応じた複数の戦略 - 完全自律ビルドからトークン効率の良いリファクタリングまで。[詳しくはこちら →](https://docs/REFERENCE.md/docs.html#execution-modes)
...
- **[CLI リファレンス](https://docs/REFERENCE.md/docs.html#cli-reference)** - すべての `omp` コマンド、フラグ、ツール
- **[通知ガイド](https://docs/REFERENCE.md/docs.html#notifications)** - Discord、Telegram、Slack、webhook のセットアップ
- **[推奨ワークフロー](https://docs/REFERENCE.md/docs.html#workflows)** - 一般的なタスクのための実績あるスキルチェーン
- **[リリースノート](https://docs/REFERENCE.md/docs.html#release-notes)** - 各バージョンの新機能
- **[ウェブサイト](https://docs/REFERENCE.md)** - インタラクティブガイドと例
