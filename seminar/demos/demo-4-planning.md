...
**What happens:**
- OMP detects broad request: "authentication system" without specifics
- Plan skill activates
- Announces: "I'm starting a planning session - I'll interview you about requirements"

**Presenter talking points:**
- "OMP detected a broad request - 'authentication' could mean many things"
...
```
/oh-my-copilot:review auth-system
```
