...
This directory contains demo scripts for showcasing Oh-My-Copilot's capabilities.
...
### Required Setup
- OMC installed and configured (`/oh-my-copilot:omc-setup` completed)
...
- [ ] No active OMC operations running (`/oh-my-copilot:cancel --all`)
...
### Opening (1 min)
"Today I'll show you Oh-My-Copilot - a multi-agent orchestration system that transforms Claude from a single assistant into a coordinated team of specialists. Instead of doing everything yourself, you conduct a symphony of AI agents, each optimized for specific tasks."
...
### Closing (1 min)
"OMC transforms how you work with Claude - from manual coding to orchestrating specialized agents. All open source at github.com/Yeachan-Heo/oh-my-copilot."
...
- **State cleanup**: Between demos, verify clean state with `/oh-my-copilot:cancel`
...
**Solution**: Jump to next phase or use `/oh-my-copilot:cancel` and show fallback
