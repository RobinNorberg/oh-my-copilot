# Screenshot Guide for OMP Seminar
...
3. Run: `copilot` (start Copilot CLI)
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ copilot @ oh-my-copilot                                    [Phase 4/5] ⚡ │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
**Description:** Split-screen comparison showing manual Copilot CLI usage on left vs. OMP orchestrated on right, demonstrating the difference in workflow.
...
```
┌─────────────────────────────────────┬─────────────────────────────────────┐
│ BEFORE: Manual Copilot CLI          │ AFTER: OMP Orchestration            │
├─────────────────────────────────────┼─────────────────────────────────────┤
...
**Capture Instructions:**
1. Ensure HUD is installed: `copilot` then `/oh-my-copilot:hud setup`
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ 🎯 OMP HUD │ Agents: 3 active │ Todos: 8/15 done │ Tokens: 145K/200K │ 🟢   │
...
│ OMP│ 3 active │  8/15 done  │ 145K/200K    │  🟢    │
│ HUD│          │   (53%)     │   (73%)      │        │
└────┴──────────┴─────────────┴──────────────┴────────┘
...
asciinema rec -t "OMP Autopilot Demo" autopilot-demo.cast
...
tmux new-session \; \
  ...
  select-pane -t 1 \; \
  send-keys "# AFTER: OMP workflow" C-m
```
