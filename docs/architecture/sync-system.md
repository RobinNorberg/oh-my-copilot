...
5. **Forgets** to update agent count in `.github/copilot-instructions.md` after adding new agents
...
| `.github/copilot-instructions.md` | Agent count, skill count |
