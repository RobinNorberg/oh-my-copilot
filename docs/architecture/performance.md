...
Comprehensive guide to monitoring, debugging, and optimizing Copilot CLI and oh-my-copilot performance.
...
oh-my-copilot provides comprehensive monitoring capabilities for tracking agent performance, token usage, costs, and identifying bottlenecks in multi-agent workflows. This guide covers both built-in tools and external resources for monitoring Copilot's performance.
...
```typescript
import { getAgentObservatory } from 'oh-my-copilot/hooks/subagent-tracker';
...
Analyze historical Copilot CLI transcripts:
...
```typescript
import { getReplaySummary } from 'oh-my-copilot/hooks/subagent-tracker/session-replay';
...
```typescript
import { getAgentPerformance } from 'oh-my-copilot/hooks/subagent-tracker';
...
```typescript
import { detectFileConflicts } from 'oh-my-copilot/hooks/subagent-tracker';
...
```typescript
import { suggestInterventions } from 'oh-my-copilot/hooks/subagent-tracker';
...
```typescript
import { calculateParallelEfficiency } from 'oh-my-copilot/hooks/subagent-tracker';
...
```typescript
import { cleanupStaleAgents } from 'oh-my-copilot/hooks/subagent-tracker';
...
### Copilot Performance Tracking Platforms

#### MarginLab.ai

[MarginLab.ai](https://marginlab.ai) provides external performance tracking for Copilot models:

- **SWE-Bench-Pro daily tracking**: Monitor Copilot's performance on software engineering benchmarks
- **Statistical significance testing**: Detect performance degradation with confidence intervals
- **Historical trends**: Track Copilot's capabilities over time
- **Model comparison**: Compare performance across Copilot model versions

#### Usage

Visit the platform to:
1. View current Copilot model benchmark scores
...
Track Copilot's performance across standard benchmarks:
...
```typescript
import { cleanupReplayFiles } from 'oh-my-copilot/hooks/subagent-tracker/session-replay';
