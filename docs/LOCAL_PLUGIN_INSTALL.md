...
How to install oh-my-copilot from a local development directory as a Claude Code plugin.
...
# Uninstall
claude plugin uninstall oh-my-copilot@oh-my-copilot

# Remove marketplace
claude plugin marketplace remove oh-my-copilot
```
