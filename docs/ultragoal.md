...
`omg ultragoal` is a durable, repo-native multi-goal workflow that pairs with
...
```
omg ultragoal create-goals  [--brief <text> | --brief-file <path> | --from-stdin]
                            [--goal <title::objective>]...
                            [--claude-goal-mode <aggregate|per-story>] [--force] [--json]
omg ultragoal complete-goals  [--retry-failed] [--json]
omg ultragoal add-goal       --title <title> --objective <text> [--evidence <text>] [--json]
omg ultragoal record-review-blockers
                            --goal-id <id> --title <title> --objective <text>
                            --evidence <review-findings>
                            --claude-goal-json <active-json-or-path> [--json]
omg ultragoal checkpoint    --goal-id <id> --status <complete|failed|blocked>
                            [--evidence <text>]
                            [--claude-goal-json <json-or-path>]
                            [--quality-gate-json <json-or-path>] [--json]
omg ultragoal status        [--claude-goal-json <json-or-path>] [--json]
```
...
`omg ultragoal record-review-blockers` instead of trying to mark the goal
