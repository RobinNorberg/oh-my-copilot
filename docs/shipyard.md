...
This page is the map of the methodology: the boundary principle, the four pillars, the surface layout, the working metaphor, and how the three skills compose. The skills themselves (`/oh-my-copilot:drydock`, `/oh-my-copilot:launch`, `/oh-my-copilot:minimal-code-discipline`) are the executable form. For the visual quick-start with emoji and mermaid diagrams, see [shipyard-guide.md](./shipyard-guide.md).
