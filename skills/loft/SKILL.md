...
- It does not diagnose (debugger), does not chart fog (`/oh-my-copilot:ask-navigator`), does not approve its own answer (the captain's reaction is the only acceptance).
