...
Reusable skills are not code snippets to copy-paste, but **principles and decision-making heuristics** that teach Copilot HOW TO THINK about a class of problems.
...
A good skill changes how Copilot APPROACHES problems, not just what code it produces.
...
Use /oh-my-copilot:learner ONLY after:
...
- **User-level**: ~/.copilot/skills/omg-learned/ - Rare. Only for truly portable insights.
...
## The Approach
The decision-making heuristic, not just code. How should Copilot THINK about this?
...
**Key**: A skill is REUSABLE if Copilot can apply it to NEW situations, not just identical ones.
