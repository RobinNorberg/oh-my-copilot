...
<Tool_Usage>
- Use `Task(subagent_type="oh-my-copilot:architect", ...)` for verification cross-checks when changes are security-sensitive, architectural, or involve complex multi-system integration
