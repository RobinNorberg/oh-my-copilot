...
<Tool_Usage>
- Use `Task(subagent_type="oh-my-copilot:executor", model="haiku", ...)` for simple changes
- Use `Task(subagent_type="oh-my-copilot:executor", model="sonnet", ...)` for standard work
- Use `Task(subagent_type="oh-my-copilot:executor", model="opus", ...)` for complex work
