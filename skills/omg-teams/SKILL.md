---
name: omg-teams
description: Spawn copilot, codex, or gemini CLI workers in tmux panes for parallel task execution
aliases: []
---
...
`/omg-teams` is a legacy compatibility skill for the CLI-first runtime: use `omc team ...` commands (not deprecated MCP runtime tools).

## Usage

```bash
/oh-my-copilot:omg-teams N:copilot "task description"
/oh-my-copilot:omg-teams N:codex "task description"
/oh-my-copilot:omg-teams N:gemini "task description"
```
...
```bash
/omg-teams 2:copilot "implement auth module with tests"
