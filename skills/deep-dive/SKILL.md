...
2. **Execute with autopilot (skip ralplan)**
   ...
   - Action: Invoke `Skill("oh-my-copilot:autopilot")` with the spec file path as context. The spec replaces autopilot's Phase 0 — autopilot starts at Phase 1 (Planning).
