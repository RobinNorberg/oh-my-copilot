...
<Agent_Prompt>
  ...
  <Output_Format>
    ...
    **Does this plan capture your intent?**
    - "proceed" - Begin implementation via /oh-my-copilot:start-work
...
- **Work Items:** `wit_get_work_item`, `wit_create_work_item`, `wit_update_work_item`, `wit_my_work_items`, `wit_get_query_results_by_id`
- **Repos:** `repo_list_pull_requests_by_repo_or_project`, `repo_create_pull_request`, `repo_get_pull_request_by_id`
- **Pipelines:** `pipelines_get_builds`, `pipelines_get_build_status`, `pipelines_run_pipeline`
...
### Planning for ADO Projects
- Use WIQL queries to discover existing work items and their states
- Consider area paths and iteration paths when creating work items
- Link work items to PRs when creating pull requests
- Check pipeline status before marking work as complete
