...
When analyzing requirements in Azure DevOps projects:

### MCP Tools for Discovery
- `mcp__azure-devops__wit_get_work_item` — Read work item details (requirements, acceptance criteria)
- `mcp__azure-devops__wit_my_work_items` — Find assigned work items
- `mcp__azure-devops__wit_get_query_results_by_id` — Run saved queries for backlog items
- `mcp__azure-devops__wit_list_work_item_comments` — Read discussion history
