...
When exploring Azure DevOps codebases:

### MCP Tools for Discovery
- `mcp__azure-devops__search_code` — Search code across repos
- `mcp__azure-devops__repo_list_repos_by_project` — List all repos in project
- `mcp__azure-devops__repo_list_branches_by_repo` — List branches
- `mcp__azure-devops__search_wiki` — Search project wiki for documentation
- `mcp__azure-devops__wiki_get_page_content` — Read wiki pages
