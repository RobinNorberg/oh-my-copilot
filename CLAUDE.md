...
Direct writes OK for: `~/.copilot/**`, `.omg/**`, `.copilot/**`, `~/.claude/**`, `.claude/**`, `copilot-instructions.md`, `CLAUDE.md`, `AGENTS.md`.
</model_routing>
...
Release is maintainer-only `omg release` (see Migration Guide); `/release` remains a compatibility alias and never bypasses the release boundary.
