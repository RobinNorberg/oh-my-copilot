...
This document describes the security configuration and deployment guidelines for oh-my-copilot (OMC).
...
- Install OMC manually (`oh-my-copilot install`), not via agent
...
If you discover a security vulnerability, please report it via [GitHub Issues](https://github.com/Yeachan-Heo/oh-my-copilot/issues) with the `security` label.
