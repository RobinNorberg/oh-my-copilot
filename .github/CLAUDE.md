# Copilot AI Instructions for oh-my-copilot

This file provides context for Copilot when working on this repository via GitHub Actions.

## Repository Overview

oh-my-copilot is a Copilot CLI plugin that provides multi-agent orchestration capabilities.

### Key Features
- **18 specialized agents** with intelligent model routing (Haiku/Sonnet/Opus tiers)
- **32 slash commands** including /oh-my-copilot:ultrawork, /oh-my-copilot:deepinit, /oh-my-copilot:ralph
...
### Bug Reports
- Ask for Copilot CLI version if not provided
